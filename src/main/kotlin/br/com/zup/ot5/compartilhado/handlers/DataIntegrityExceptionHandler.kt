...
@Singleton
class DataIntegrityExceptionHandler(@Inject var messageSource: MessageSource) : CustomExceptionHandler<ConstraintViolationException> {
    ...
    private fun alreadyExistsError(message: String?, e: ConstraintViolationException) =
        CustomExceptionHandler.StatusWithDetails(
